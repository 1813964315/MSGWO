...
# egwo_model = get_optimizer_by_name("OriginalEGWO")(epoch, pop_size)
...
# egwo_best_x, egwo_best_f = egwo_model.solve(problem_dict)
# 运行算法（确保已经执行此步骤）
fitness_curve, best_individual = IEMGWO(cec_fun,dim,epoch,pop_size)
# In[]:
...
plt.plot(fitness_curve, 'g-', linewidth=2, label='EGWO')
